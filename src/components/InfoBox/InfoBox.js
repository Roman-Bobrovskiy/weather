      ...
      {cityData.length !== 0 && (
        <div className={styles.wrapInfoBox}>
          <ul className={styles.infoContainer}>
            <li className={styles.infoItems}>
              <span className={styles.infoSvgImg}>
                <svg
                  width="26"
                  height="26"
                  fill="currentColor"
              ...
              Cloudiness: {cityData.current.clouds} %
            </li>
            <li className={styles.infoItems}>
              <span className={styles.infoSvgImg}>
                <svg
              ...
              Feels like: {getTempInCelsius(cityData.current.feels_like)} °
            </li>
            <li className={styles.infoItems}>
              <span className={styles.infoSvgImg}>
                <svg
              ...
              Dew point: {getTempInCelsius(cityData.current.dew_point)} °
            </li>
            <li className={styles.infoItems}>
              <span className={styles.infoSvgImg}>
                <svg
          ...
          <ul className={styles.infoContainer}>
            ...
            <li className={styles.infoItems}>
              ...
              Visibility: {cityData.current.visibility / 1000} km{" "}
            </li>
          </ul>
        </div>
      )}
